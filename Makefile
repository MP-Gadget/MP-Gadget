...
#OPT	+=  -DASMTH=1.25
#OPT	+=  -DRCUT=4.5
OPT	+=  -DPLACEHIGHRESREGION=1+2+8
OPT	+=  -DENLARGEREGION=2.0
...
FFTW_INCL= -I/opt/fftw/impi_intel-3.2/include
FFTW_LIBS= -L/opt/fftw/impi_intel-3.2/lib64 -Wl,-rpath,/opt/fftw/impi_intel-3.2/lib64
