...
static inline void
SETSEED(PMField * pm, unsigned int * table[2][2], int i, int j, gsl_rng * rng)
{
...
GETSEED(PMField * pm, unsigned int * table[2][2], int i, int j, int d1, int d2)
{
...
static void
pmic_fill_gaussian_gadget(PMField * pm, double * delta_k, int seed, int setUnitaryAmplitude, int setInvertPhase)
{
