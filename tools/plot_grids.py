...
ap.add_argument("--gridnames", default="d,xhi", help='comma separated list of prefixes of the desired grids')
...
for i,slab in enumerate(slab_list):
    ...
    im = ax.imshow(slab,cmap=cm.Purples,norm=matplotlib.colors.LogNorm(),origin='lower',extent=ext)
    plt.colorbar(im)
