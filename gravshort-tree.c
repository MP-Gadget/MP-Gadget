...
static int grav_short_tree_isactive(int i);
void grav_short_tree_copy(int place, TreeWalkQueryGravShort * input) ;
void grav_short_tree_reduce(int place, TreeWalkResultGravShort * result, enum TreeWalkReduceMode mode);
static void grav_short_tree_postprocess(int i);
...
int force_treeev_shortrange(TreeWalkQueryGravShort * input,
        ...
        LocalTreeWalk * lv)
{
    return force_treeevaluate_shortrange( input, output, lv);
