...
void cooling_and_starformation(ActiveParticles * act, double Time, double dloga, ForceTree * tree, DomainDecomp * ddecomp, const Cosmology * CP, MyFloat * GradRho, FILE * FdSfr);
