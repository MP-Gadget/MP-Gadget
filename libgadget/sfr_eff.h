...
void cooling_and_starformation(ActiveParticles * act, double Time, const DriftKickTimes * const times, double dloga, ForceTree * tree, DomainDecomp * ddecomp, Cosmology * CP, MyFloat * GradRho, FILE * FdSfr);
