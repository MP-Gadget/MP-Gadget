...
void init(int snapnum, Domain * domain); /* init.c only used here */
 ...
 */
static void compute_accelerations(int is_PM, int FirstStep, int GasEnabled, ForceTree * tree, Domain * domain);
...
void begrun(int RestartSnapNum, Domain * domain)
{
    ...
    init(RestartSnapNum, domain);			/* ... read in initial model */
...
void run(Domain * domain)
{
    ...
    while(1) /* main loop */
    {
        ...
        compute_accelerations(is_PM, NumCurrentTiStep == 0, GasEnabled, &Tree, domain);
 ...
 */
void compute_accelerations(int is_PM, int FirstStep, int GasEnabled, ForceTree * tree, Domain * domain)
{
