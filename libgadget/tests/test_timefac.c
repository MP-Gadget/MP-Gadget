...
void test_drift_factor(void ** state)
{
    ...
    assert_true(fabs(get_exact_drift_factor(get_ti(0.8), get_ti(0.85)) + 2/0.1*(1/sqrt(0.85) - 1/sqrt(0.8))) < 5e-5);
    /*Test the kick table*/
    assert_true(fabs(get_gravkick_factor(get_ti(0.8), get_ti(0.85)) - 2/0.1*(sqrt(0.85) - sqrt(0.8))) < 5e-5);

    //Chosen so we get the same bin
    assert_true(fabs(get_exact_drift_factor(get_ti(0.8), get_ti(0.8003)) + 2/0.1*(1/sqrt(0.8003) - 1/sqrt(0.8))) < 5e-6);
    ...
    assert_true(fabs(get_hydrokick_factor(get_ti(0.8), get_ti(0.85)) - get_exact_drift_factor(get_ti(0.8), get_ti(0.85))) < 5e-5);
