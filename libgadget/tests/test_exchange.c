...
test_exchange(void **state)
{
    ...
    int fail = domain_exchange(&test_exchange_layout_func, NULL, 1, NULL, NULL, PartManager, SlotsManager,10000, MPI_COMM_WORLD);
...
test_exchange_uneven(void **state)
{
    ...
    int fail = domain_exchange(&test_exchange_layout_func_uneven, NULL, 1, NULL, NULL, PartManager, SlotsManager, 10000, MPI_COMM_WORLD);
