 ...
 */
void blackhole(const ActiveParticles * act, double atime, Cosmology * CP, ForceTree * tree, DomainDecomp * ddecomp, const struct UnitSystem units, FILE * FdBlackHoles, FILE * FdBlackholeDetails);
