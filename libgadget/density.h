...
void density(const ActiveParticles * act, int update_hsml, int DoEgyDensity, MyFloat * StarVolumeSPH, int BlackHoleOn, double MinEgySpec, const DriftKickTimes times, Cosmology * CP, struct sph_pred_data * SPH_predicted, MyFloat * GradRho, const ForceTree * const tree);
