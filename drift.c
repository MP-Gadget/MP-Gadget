...
static int drift_particle_full(int i, unsigned int ti1, int blocking);

static void real_drift_particle(int i, unsigned int ti1);
...
int drift_particle_full(int i, unsigned int ti1, int blocking) {
