...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "MinFoFMassForNewSeed", OPTIONAL, 5e2, "Minimal sized halo (in number of DM particles) into which we should seed tracer particles.");
    ...
    param_declare_double(ps, "SeedBlackHoleMass", OPTIONAL, 5e-5, "Mass of initial black hole seed as a fraction of the smallest seed halo mass.");
