...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "Qeos", OPTIONAL, 1.0, "Fraction to soften the effective equation of state for ISM. If 1, back to original eqos, If 0, isothermal equation of state.");
