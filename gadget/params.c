...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "WindFreeTravelLength", OPTIONAL, 20, "Expected decoupling distance for the wind in internal distance units. Default no decoupling as this produces a better gsmf.");
