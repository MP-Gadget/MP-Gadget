...
create_gadget_parameter_set()
{
    ...
    param_declare_int(ps, "SplitGravityTimestepsOn", OPTIONAL, 0, "This flag enables the momentum conserving hierarchical timestepping, where only active particles gravitate, from Gadget 4, for the short-range gravity, and splits the hydro and gravitational timesteps.");
