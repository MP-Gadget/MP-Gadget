...
c
      DATA h2_lte /-25.390, -25.086, -24.791, -24.510, -24.245, -23.999, 
...
c
c Opacity correction -- Sobolev approx., as in YOHA06
c
      integer nh2op
      parameter(nh2op = 101)
      REAL h2_opac_temp(nh2op), h2_opac_column(nh2op), 
     $     h2_opac(nh2op,nh2op)
c
      common /h2_opac_data/ h2_opac_temp, h2_opac_column, h2_opac
c
c CO & H2O optically thick rotational cooling 
c
      integer nco_temp, nco_column, nco_data
      parameter (nco_temp   = 12)
      parameter (nco_column = 10)
c NB: nco_data == nco_temp * nco_column
      parameter (nco_data   = 120)
c
      integer nh2o_temp_low, nh2o_temp_high, nh2o_temp
      integer nh2o_column
      integer nh2o_data_low, nh2o_data_high, nh2o_data
      parameter (nh2o_temp_low  = 6)
      parameter (nh2o_temp_high = 5)
      parameter (nh2o_temp = nh2o_temp_low + nh2o_temp_high)
      parameter (nh2o_column    = 10)
      parameter (nh2o_data_low  = 60)
      parameter (nh2o_data_high = 50)
      parameter (nh2o_data = nh2o_data_low + nh2o_data_high)
c
      integer nco_vib_temp, nco_vib_column, nco_vib_data
      parameter (nco_vib_temp   = 6)
      parameter (nco_vib_column = 8)
      parameter (nco_vib_data   = 48)
c
      integer nh2o_vib_temp, nh2o_vib_column, nh2o_vib_data
      parameter (nh2o_vib_temp   = 6)
      parameter (nh2o_vib_column = 8)
      parameter (nh2o_vib_data   = 48)
c
      REAL co_temp(nco_temp),     co_column(nco_column)
      REAL co_data_L0(nco_temp),  co_data_LTE(nco_data), 
     $     co_data_n05(nco_data), co_data_alp(nco_data)
c
      REAL co_vib_temp(nco_vib_temp), 
     $     co_vib_column(nco_vib_column), 
     $     co_vib_LTE(nco_vib_data)
c
      REAL h2o_temp_low(nh2o_temp_low), 
     $     h2o_temp_high(nh2o_temp_high), 
     $     h2o_temp(nh2o_temp),
     $     h2o_column(nh2o_column)
c
      REAL h2o_L0_low_ortho(nh2o_temp_low),  
     $     h2o_LTE_low_ortho(nh2o_data_low), 
     $     h2o_n05_low_ortho(nh2o_data_low), 
     $     h2o_alp_low_ortho(nh2o_data_low)
c
      REAL h2o_L0_low_para(nh2o_temp_low),  
     $     h2o_LTE_low_para(nh2o_data_low), 
     $     h2o_n05_low_para(nh2o_data_low), 
     $     h2o_alp_low_para(nh2o_data_low)
c
      REAL h2o_L0_high(nh2o_temp_high),  
     $     h2o_LTE_high(nh2o_data_high), 
     $     h2o_n05_high(nh2o_data_high), 
     $     h2o_alp_high(nh2o_data_high)

      REAL h2o_data_L0_ortho(nh2o_temp),
     $     h2o_data_LTE_ortho(nh2o_data),
     $     h2o_data_n05_ortho(nh2o_data),
     $     h2o_data_alp_ortho(nh2o_data)

      REAL h2o_data_L0_para(nh2o_temp),
     $     h2o_data_LTE_para(nh2o_data),
     $     h2o_data_n05_para(nh2o_data),
     $     h2o_data_alp_para(nh2o_data)

      REAL h2o_vib_temp(nh2o_vib_temp), 
     $     h2o_vib_column(nh2o_vib_column), 
     $     h2o_vib_LTE(nh2o_vib_data)
c
c CO rotational cooling:
c
      DATA co_temp /5., 10., 20., 30., 50., 80., 100., 300., 600., 
     $              1000., 1500., 2000./

      DATA co_column /14.5, 15.0, 15.5, 16.0, 16.5, 17.0, 17.5, 18.0,
     $                18.5, 19.0/
